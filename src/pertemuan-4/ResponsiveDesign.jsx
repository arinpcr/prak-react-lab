export function ResponsiveDesign(){
    return (
        ...
        <p className="text-sm
         ...
         lg:text-blue-500 md:text-lg
         xl:text-green-500 xl:text-2xl
         mb-4">
    ...
    return (
        <div className="mb-4">
            ...
            <div className="flex flex-col md:flex-row mb-4">
                <div className="bg-pink-500 w-full md:w-1/2 p-4">Kolom 1</div>
    ...
    return (
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
                <div class="bg-pink-500 p-4">Box 1</div>
                <div class="bg-pink-500 p-4">Box 2</div>
                <div class="bg-pink-500 p-4">Box 3</div>
                <div class="bg-pink-500 p-4">Box 4</div>
            </div>
        </div>
    )
}